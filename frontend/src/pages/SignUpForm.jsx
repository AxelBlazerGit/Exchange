    ...
    <div className="bg-teal-50 flex flex-col items-center justify-center min-h-screen md:py-2">
      ...
      <div className="bg-slate-700 text-white rounded-2xl shadow-2xl flex flex-col w-full md:w-1/3 items-center max-w-4xl transition duration-1000 ease-in p-6">
        ...
        <div className="flex flex-col items-center justify-center mt-4">
          ...
          <input type="text" className="rounded-2xl px-4 py-2 w-4/5 md:w-full border-[2px] border-teal-400 m-2 focus:shadow-lg focus:border-white focus:outline-none transition duration-300 text-black" placeholder="Institution" />
          <input type="text" className="inline rounded-2xl px-4 py-2 w-1/2 md:w-full border-[2px] border-teal-400 m-2 focus:shadow-lg focus:border-white focus:outline-none transition duration-300 text-black" placeholder="Place" />
          <button className="rounded-2xl m-2 text-teal-500 bg-white w-1/2 px-4 py-2 shadow-md hover:bg-teal-500 hover:text-white border-[2px] border-teal-500 transition duration-300 inline">
            Sign Up
          </button>
        </div>
        ...
        <p className="text-white m-4 text-sm">
          ...
          <Link to='/login' className="underline underline-offset-4 text-teal-300 ml-1 cursor-pointer hover:text-teal-400 transition duration-300" onClick={() => setIsLogin(true)}>Sign In</Link>
        </p>
      </div>
    )
