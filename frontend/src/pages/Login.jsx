    ...
    return (
      <div className="bg-teal-100 rounded-2xl shadow-2xl flex flex-col w-full md:w-1/3 items-center max-w-4xl transition duration-1000 ease-out p-6">
        ...
        <p className="text-teal-500 m-4 text-sm">
          ...
          <span className="underline underline-offset-4 text-teal-600 ml-1 cursor-pointer hover:text-slate-700 transition duration-300" onClick={() => setIsLogin(false)}>Sign Up</span>
        </p>
      </div>
    );
  };
    ...
    return (
      <div className="bg-slate-700 text-white rounded-2xl shadow-2xl flex flex-col w-full md:w-1/3 items-center max-w-4xl transition duration-1000 ease-in p-6">
        ...
        <p className="text-white m-4 text-sm">
          ...
          <span className="underline underline-offset-4 text-teal-300 ml-1 cursor-pointer hover:text-teal-400 transition duration-300" onClick={() => setIsLogin(true)}>Sign In</span>
        </p>
      </div>
    );
  };
